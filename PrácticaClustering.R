...
#plotCluster1 = matrix(nrow = length(cluster1), ncol = 2)
#for(i in 1:length(cluster1)){
  #plotCluster1[i, 1] = petalMatrix[cluster1[i], 1]
  #plotCluster1[i, 2] = petalMatrix[cluster1[i], 2]
#}
